...
def set_scale_params(N,M,K,N_list,M_list,K_list,tot,R):
  ...
  # adjusted to reflect effect of state-level groundwater management (influenced by smaller
  # growers and rural communities and support rural communities)
  ...
  # same as base, with additional burden of groundwater supply regulations
