...
Summary of changes from base parameterization:
 - Add in GSAs and their impact on extraction through SGMA (not as influential as v2 though)
 - Add in state intervention in SGMA (and undermining of GSAs)
 - stronger enforcement of gw quality regulations
 - more funding for orgs
'''
